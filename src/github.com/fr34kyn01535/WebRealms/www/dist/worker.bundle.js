...
var Client = function () {
    function Client(window) {
        ...
        var packetBuilder = this.packetBuilder = webrealms_proto_js_1.main.ProtocolPacket;
        this.connect();
    ...
    Client.prototype.connect = function () {
        ...
        this.socket.onmessage = function (event) {
            try {
                var packet = that.packetBuilder.decode(new Uint8Array(event.data));
                for (var _i = 0, _a = packet.Message; _i < _a.length; _i++) {
                    var message = _a[_i];
    ...
    Client.prototype.sendPacket = function (messages) {
        var packet = webrealms_proto_js_1.main.ProtocolPacket.create();
        packet.Message = messages;
        var data = this.packetBuilder.encode(packet).finish();
